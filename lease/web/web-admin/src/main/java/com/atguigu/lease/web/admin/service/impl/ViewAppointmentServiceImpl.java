...
public class ViewAppointmentServiceImpl extends ServiceImpl<ViewAppointmentMapper, ViewAppointment>
    ...
    @Override
    public IPage<AppointmentVo> pageAppointment(Page<Object> objectPage, AppointmentQueryVo queryVo) {
        return viewAppointmentMapper.pageAppointment(objectPage, queryVo);
    }
}
